...
class AudioManager
{
    ...
    public:
        /** @brief The Get SoundBuffer function uses a hashtable to associate a filename with an instance of a SoundBuffer.
          ...
          * @param filename[in] The path to an audio file (WAV, OGG, SGI, DEC, AU, SND, AIFF, AIFC, RAW, IFF,  SVX, VOC, W64, MAT4, MAT5, PVF, XI, HTK, CAF, SD2, FLAC)
        ...
        /** @brief The Get SoundBuffer function uses a hashtable to associate a filename with an instance of a SoundBuffer.
          ...
          * @param filename[in] The path to an audio file (WAV, OGG, SGI, DEC, AU, SND, AIFF, AIFC, RAW, IFF,  SVX, VOC, W64, MAT4, MAT5, PVF, XI, HTK, CAF, SD2, FLAC)
          * @param addToMap[in] A flag which allows a SoundBuffer to be loaded but not managed by the AudioManager (i.e. not associated with this filename)
          * @return On success the function returns a SoundBuffer otherwise 0 **/
    ...
    protected:
        /** @brief The GetRelativePath function extracts the name of a file and discards path information
          * @param filename[in] The filename that we wish to discard the path from
        ...
        /** @brief The toUpperCase function cconverts a string to upper case
          * @param text[in] The String we want to make upper case
        ...
        /** @brief The toLowerCase function converts a string to lower case
          * @param text[in] The String we want to make lower case
        ...
        /** @brief The convertBoolToString method converts a bool to a string
          * @param value[in] The value we want to convert to string
        ...
        /** @brief The convertStringToBool method converts a string to a bool
          * @param value[in] The value we want to convert to a bool. (not case sensitive)
